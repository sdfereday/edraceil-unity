...
public class InventoryHistory : MonoBehaviour
{
    /*
     ...
     Using an interface, we can trigger the save of all things to storage. This
     isn't quite ready yet, but all histories and stores will ultimately save their
     data in to the same spot and load out of there in turn.
     */
     [System.Serializable]
